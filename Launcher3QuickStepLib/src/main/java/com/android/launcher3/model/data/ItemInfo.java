...
public class ItemInfo {
    ...
    public void writeToValues(ContentWriter writer) {
        writer.put(Favorites.ITEM_TYPE, itemType)
                .put(Favorites.CONTAINER, container)
                .put(Favorites.SCREEN, screenId)
    ...
    public void readFromValues(ContentValues values) {
        itemType = values.getAsInteger(Favorites.ITEM_TYPE);
        container = values.getAsInteger(Favorites.CONTAINER);
        screenId = values.getAsInteger(Favorites.SCREEN);
        cellX = values.getAsInteger(Favorites.CELLX);
        cellY = values.getAsInteger(Favorites.CELLY);
        spanX = values.getAsInteger(Favorites.SPANX);
        spanY = values.getAsInteger(Favorites.SPANY);
        rank = values.getAsInteger(Favorites.RANK);
    }
    ...
    public void onAddToDatabase(ContentWriter writer) {
        ...
        writer.put(Favorites.PROFILE_ID, user);
    }
    ...
    protected String dumpProperties() {
        return "id=" + id
                + " type=" + Favorites.itemTypeToString(itemType)
